...
const register = async (req, res) => {
  try {
    ...
    const cvAttach = req.body.cvAttach;
    const passportAttach = req.body.cvAttach;
    ...
    const createUser = await prisma.user.create({
      data: {
        ...
        image: imageUrl,
        phoneAlter: req.body.phoneAlter,
        ...
        experiences: {
          create: req.body.experiences.map((e) => {
            return {
              position: e.position,
              company: e.company,
              exCountry: e.exCountry,
              year: new Date(e.year),
            };
          }),
        },
        educations: {
