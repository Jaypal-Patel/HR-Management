  ...
  async (id) => {
    try {
      const resp = await axios({
        ...
        url: `${BackendUrl}/awardHistory/${id}`,
      });
...
export const loadSingleAwardHistory = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/awardHistory/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllAwardHistory = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/awardHistory?query=all`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
