  ...
  async (values) => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/leave-application/`,
        data: {
          ...values,
        },
      });
  ...
  async ({ id, values }) => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/leave-application/${id}`,
        data: {
          ...values,
        },
      });
...
export const loadSingelLeaveApplication = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/leave-application/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
  ...
  async ({ status, page, limit }) => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/leave-application?page=${page}&count=${limit}&status=${status}`
      );
      return data;
    } catch (error) {
      console.log(error.message);
...
export const loadAllLeaveApplication = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/leave-application?query=all`
      );
...
export const countLeaveApplication = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/leave-application`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadSingleLeaveHistory = createAsyncThunk(
  ...
  async (id) => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/leave-application/${id}/leaveHistory`
      );
      return data;
    } catch (error) {
      console.log(error.message);
