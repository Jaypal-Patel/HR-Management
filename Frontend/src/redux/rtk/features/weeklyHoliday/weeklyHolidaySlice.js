  ...
  async (id) => {
    try {
      const resp = await axios({
        ...
        url: `${BackendUrl}/weekly-holiday/${id}`,
      });
...
export const loadSingleWeeklyHoliday = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/weekly-holiday/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
  ...
  async () => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/weekly-holiday?query=all`
      );
      return data;
    } catch (error) {
      console.log(error.message);
