  ...
  async (id) => {
    try {
      const resp = await axios({
        ...
        url: `${BackendUrl}/public-holiday/${id}`,
      });
...
export const loadSinglePublicHoliday = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/public-holiday/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
  ...
  async () => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/public-holiday?query=all`
      );
      return data;
    } catch (error) {
      console.log(error.message);
