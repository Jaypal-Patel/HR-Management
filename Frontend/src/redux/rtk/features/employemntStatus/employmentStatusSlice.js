  ...
  async (values) => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/employment-status/`,
        data: {
          ...values,
        },
      });
  ...
  async (id) => {
    try {
      const resp = await axios({
        ...
        url: `${BackendUrl}/employment-status/${id}`,
        data: {
          status: false,
        },
      });
...
export const loadSingelEmploymentStatus = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/employment-status/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
  ...
  async () => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/employment-status?status=true`
      );
      return data;
    } catch (error) {
      console.log(error.message);
