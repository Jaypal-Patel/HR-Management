...
export const loadAllPayslipForPayment = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/payroll/all`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
  ...
  async ({ month, year, status }) => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/payroll/all?value=monthWise&paymentStatus=${status}&salaryMonth=${month}&salaryYear=${year}`
      );
      return data;
    } catch (error) {
      console.log(error.message);
...
export const loadSinglePayslip = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/payroll/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllPayslip = createAsyncThunk(
  ...
  async ({ month, year }) => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/payroll?salaryMonth=${month}&salaryYear=${year}`
      );
      return data;
    } catch (error) {
      console.log(error.message);
