  ...
  async (id) => {
    try {
      const resp = await axios({
        ...
        url: `${BackendUrl}/assigned-task/${id}`,
      });
...
export const loadSingleAssignedTask = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/assigned-task/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllAssignedTask = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/assigned-task?query=all`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
