...
export const loadSingleMilestone = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/milestone/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllMilestone = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/milestone?query=all`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllMilestoneByProjectId = createAsyncThunk(
  ...
  async (id) => {
    try {
      const { data } = await axios.get(`${BackendUrl}/milestone/${id}/project`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
  ...
  async ({ id, values }) => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/milestone/${id}?query=all`,
        data: {
          ...values,
        },
      });
  ...
  async ({ id, values }) => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/milestone/${id}/status`,
        data: {
          ...values,
        },
      });
