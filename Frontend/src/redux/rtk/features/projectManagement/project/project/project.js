...
export const loadSingleProject = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/project/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllProject = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/project?query=all`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
  ...
  async (status) => {
    try {
      const { data } = await axios.get(
        `${BackendUrl}/project?status=${status}`
      );
      return data;
    } catch (error) {
      console.log(error.message);
