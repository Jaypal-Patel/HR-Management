...
export const loadSingleDesignation = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/designation/employee/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllDesignation = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/designation?status=true`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllDesignationByEmployee = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/designation/employee`);
