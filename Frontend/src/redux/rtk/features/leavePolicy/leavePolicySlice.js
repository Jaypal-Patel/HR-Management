  ...
  async (id) => {
    try {
      const resp = await axios({
        ...
        url: `${BackendUrl}/leave-policy/${id}`,
      });
...
export const loadSingleLeavePolicy = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/leave-policy/${id}`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
...
export const loadAllLeavePolicy = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axios.get(`${BackendUrl}/leave-policy?query=all`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
