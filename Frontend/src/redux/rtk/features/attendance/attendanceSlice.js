...
export const getCurrentUserClockInStatus = createAsyncThunk(
  ...
  async (id) => {
    try {
      const data = await axios.get(`${BackendUrl}/attendance/${id}/last`);
      return data;
    } catch (error) {
      console.log(error.message);
    }
  ...
  async (values) => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/attendance?query=manualPunch`,
        data: {
          ...values,
        },
      });
  ...
  async ({ page, startdate, enddate, limit }) => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/attendance?page=${page}&count=${limit}&startdate=${startdate}&enddate=${enddate}`,
      });
      return data;
    } catch (error) {
  ...
  async () => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/attendance?query=all`,
      });
      return data;
    } catch (error) {
      toast.error("Error in getting Attendance list try again");
  ...
  async (id) => {
    try {
      const { data } = await axios({
        ...
        url: `${BackendUrl}/attendance/${id}/user`,
      });
